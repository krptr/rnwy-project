...
function Navbar() {
  ...
  return (
    <>
      <header className="bg-surface/90 backdrop-blur flex justify-between font-sans items-center px-4 py-4 lg:px-32 lg:py-6 border-b border-outline-variant z-20 sticky top-0">
        <div>
          <Link to="/">
